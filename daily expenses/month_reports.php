...
$ret=mysqli_query($con,"SELECT month(DATE) as rptmonth,year(DATE) as rptyear,SUM(AMOUNT) as totalmonth FROM exp  where (DATE BETWEEN '$fdate' and '$tdate') && (ID='$userid') group by month(DATE),year(DATE)");
