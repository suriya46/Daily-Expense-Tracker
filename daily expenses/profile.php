...
if (strlen($_SESSION['detsuid']==0)) {
  ...
  $mobno=$_POST['contactnumber'];
     ...
     $query=mysqli_query($con, "update users set USERNAME ='$fullname', NUMBER='$mobno' where ID='$userid'");
    if ($query) {
...
?>
							<form role="form" method="post" action="">
								<div class="form-group">
									...
									<input class="form-control" type="text" value="<?php  echo $row['USERNAME'];?>" name="fullname" required="true">
								</div>
								<div class="form-group">
									<label>Email</label>
