...
$ret=mysqli_query($con,"SELECT DATE,SUM(AMOUNT) as total FROM exp  where (DATE BETWEEN '$fdate' and '$tdate') && (ID='$userid') group by DATE");
$cnt=1;
...
?>
                ...
                <tr>
                  ...
                  <td><?php  echo $ttlsl=$row['total'];?></td>
